...
import com.satsports247.databinding.LayoutMarketItemBinding
...
class SocketMarketAdapter : ListAdapter<MarketModel, CustomViewHolder>(Companion) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomViewHolder {
        ...
        val binding = LayoutMarketItemBinding.inflate(inflater, parent, false)
    ...
    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        ...
        val itemBinding = holder.binding as LayoutMarketItemBinding
