...
class UnMatchedMarketListAdapter(
    private val items: ArrayList<MarketModel>?,
    val context: Context
) :
    RecyclerView.Adapter<UnMatchedMarketListAdapter.MyViewHolder>() {

    val TAG: String = "UnMatchedMarketListAdapter"
    var adapter = UnMatchedTeamListAdapter(null, context)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        adapter = UnMatchedTeamListAdapter(dataModel.Bet, context)
