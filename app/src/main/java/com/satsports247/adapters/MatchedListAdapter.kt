...
class MatchedListAdapter(
    ...
    RecyclerView.Adapter<MatchedListAdapter.MyViewHolder>() {

    val TAG: String = "MatchedListAdapter"
    var adapter = MatchedMarketListAdapter(null, context)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        adapter = MatchedMarketListAdapter(dataModel.Market, context)
