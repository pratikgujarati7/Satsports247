...
import com.satsports247.databinding.LayoutMarketDataSingleBinding
...
class SingleMatchAdapter : ListAdapter<MarketDataModel, SingleMatchViewHolder>(Companion) {
    ...
    override fun onBindViewHolder(holder: SingleMatchViewHolder, position: Int) {
        ...
        holder.ivLive.setOnClickListener {
            ...
            SingleMarketActivity.relLiveMatch.visibility = View.VISIBLE
//            SingleMarketActivity.webView.visibility = View.VISIBLE
            SingleMarketActivity.webView.loadUrl(streamingUrl)
        }
